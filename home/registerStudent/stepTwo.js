  ...
  <div class="col-md-10">
    <form id="contactDetails">
      ...
      <div class="row" style="margin-top: 2%">
          ...
          <div class="col-md-4">
            <input id="guardianPhone" type="text" placeholder="Guardian's Phone" class="form-control">
          </div>
          <div class="col-md-4">
            <input id="guardianEmail" type="text" placeholder="Guardian's Email-id" class="form-control">
          </div>
        </div>
